...
import java.awt.Color;
 ...
 public class Tetrimino6 extends Figura{

    private final Color fill=new Color(50,164,100);
    ...
    public Tetrimino6(){
        posicion=0;
        puntos0=new Punto2D[]{new Punto2D(0,1),new Punto2D(1,1),new Punto2D(1,0),new Punto2D(2,1)};
        puntos90=new Punto2D[]{new Punto2D(0,0),new Punto2D(0,1),new Punto2D(0,2),new Punto2D(1,1)};
        puntos180=new Punto2D[]{new Punto2D(0,0),new Punto2D(1,0),new Punto2D(2,0),new Punto2D(1,1)};
        puntos270=new Punto2D[]{new Punto2D(0,1),new Punto2D(1,2),new Punto2D(1,1),new Punto2D(1,0)};
    }
    /*
